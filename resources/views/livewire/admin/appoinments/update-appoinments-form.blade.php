                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div wire:ignore class="form-group">
                                            ...
                                            <textarea id="summernote" data-note="@this" class="form-control">{!! $state['note'] !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer ml-auto">
                                <button id="submit" type="submit" class="btn btn-info"><i class="fa fa-save mr-1"></i> Save Changes</button>
                            </div>
                        </div>
                    </form>
                </div>
